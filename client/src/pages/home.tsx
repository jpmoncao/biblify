...
export default function Home() {
    ...
    return (
        <div className="p-4 pt-6 w-full max-w-[880px] mx-auto flex flex-col gap-4 animate-opacity min-h-[92vh]">
            ...
            <footer className="mt-auto text-xs text-foreground/30 text-center font-Inter">
